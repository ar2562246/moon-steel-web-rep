export const PROCESS_STEPS = [
  ...
  },
  {
    ...
    body: "Once the scope is agreed, we produce AutoCAD and DXF layouts plus item drawings for approval. You or your consultant sign off dimensions, connections, and finishes before steel is cut. Revisions happen on the drawing, not on the factory floor.",
    points: [
  ...
  },
  {
    id: "fabrication",
    title: "Fabrication",
    summary: "Built at our Karachi manufacturing facility in specified AISI 304 or 316 stainless steel.",
    body: "Equipment is manufactured at our Karachi plant in the specified AISI 304 or AISI 316 stainless steel. Cutting, forming, welding, and finishing follow the approved drawings so the finished items match the layout you signed.",
    points: [
      "Built at our Karachi manufacturing facility to the approved drawings",
  ...
  },
  {
    ...
    body: "We deliver and install across Pakistan. Our teams set units level, sealed, and ready for service. Where access or fit requires it, we complete fabrication on site rather than forcing a mismatch.",
    points: [
      "Delivery to sites across Pakistan",
